...
// Customize these values to rebrand the website for different restaurants
...
export type Location = typeof brandConfig.locations[0];
export type DeliveryPlatform = typeof brandConfig.delivery.platforms[0];
export type SocialPlatform = typeof brandConfig.social[keyof typeof brandConfig.social];