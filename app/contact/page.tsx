...
export default function ContactPage() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: 'Oui, livraison disponible sur Casablanca et Bouskoura. Commandes minimum de 50 MAD.'
    },
    {
      question: 'Quels sont vos horaires ?',
      answer: '12h00 – 00h00, Non-Stop 7 jours sur 7. Services: Sur Place · À Emporter · Livraison'
    },
    {
      question: 'Proposez-vous des plateaux pour événements ?',
      answer: 'Oui, notre Bateau Tobiko Royal est parfait pour les réceptions. Contactez-nous pour devis.'
    },
  ]
    ...
    <main className="min-h-screen bg-black">
      ...
      >
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-cream/70 text-lg max-w-2xl mx-auto">Deux adresses à votre service • Non-Stop 7/7</p>
        </div>
      </section>
      ...
      <section className="bg-black py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            {/* Casablanca Card */}
            <div className="bg-charcoal/50 border border-gold/30 p-12 relative group hover:border-gold transition-all duration-300">
              <div 
              ...
              <div className="relative z-10">
                <h3 className="text-4xl font-serif font-bold text-gold mb-2">Casablanca</h3>
                <div className="h-px w-16 bg-gold mb-6" />
                
                <div className="space-y-4 mb-8">
                  <div>
                    <p className="text-cream/60 text-xs uppercase tracking-widest mb-1">Téléphone</p>
                    <a href="tel:0520900902" className="text-cream hover:text-gold transition-colors text-lg font-serif">
                      0520 900 902
                    </a>
                  </div>
                  <div>
                    <p className="text-cream/60 text-xs uppercase tracking-widest mb-1">Horaires</p>
                    <p className="text-cream">12h00 – 00h00 • Non-Stop 7/7</p>
                  </div>
                  <div>
                    <p className="text-cream/60 text-xs uppercase tracking-widest mb-1">Services</p>
                    <p className="text-cream">Sur Place • À Emporter • Livraison</p>
                  </div>
                </div>
            ...
            <div className="bg-charcoal/50 border border-gold/30 p-12 relative group hover:border-gold transition-all duration-300">
              ...
              />
              <div className="relative z-10">
                <h3 className="text-4xl font-serif font-bold text-gold mb-2">Bouskoura</h3>
                <div className="h-px w-16 bg-gold mb-6" />
                
                <div className="space-y-4 mb-8">
                  <div>
                    <p className="text-cream/60 text-xs uppercase tracking-widest mb-1">Téléphone</p>
                    <a href="tel:0522012901" className="text-cream hover:text-gold transition-colors text-lg font-serif">
                      0522 01 29 01
                    </a>
                  </div>
                  <div>
      ...
      <section className="bg-black py-20 px-4 sm:px-6 lg:px-8 border-t border-charcoal">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            {/* Left Column */}
            <div>
              <h2 className="text-5xl font-serif font-bold text-cream mb-4">Réservez Votre Table</h2>
              <p className="text-cream/70 text-lg mb-8">Une expérience sushi inoubliable vous attend à Casablanca ou Bouskoura</p>
                ...
                <div className="flex gap-6">
                  {[
                    ...
                    <label key={loc.id} className="flex items-center gap-3 cursor-pointer">
                      ...
                      />
                      <span className="text-cream">{loc.label}</span>
                    </label>
                  ))}
                </div>
              </div>
